...
const Footer = () => {
  return (
<div className="h-full w-full bg-black pt-9">
  <div className="mx-auto w-full max-w-[1166px] px-4 xl:px-0">
    <div className="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
      <div className="md:w-[316px]">
        ...
        <p />
        <h1 className='text-white font-bold'>Ramkrishna Enterprise</h1>
        <p className="mt-[18px] text-[15px] font-normal text-white/[80%]">Transform your vision into reality with Ramkrishna Enterprise. We craft compelling advertising campaigns that captivate and convert. Let us bring your dreams to life with creativity, precision, and passion.</p>
      ...
      <div className="md:w-[316px]">
        <div className="mt-[23px] flex">
          ...
          <div className="ml-[18px]">
            <a href="tel:+918910570812" className="font-Inter text-[14px] font-medium text-white">+91 8910570812</a>
        ...
        <div className="mt-[23px] flex">
          ...
          <div className="ml-[18px]">
            <a href="mailto:spgeenmveda@gmail.com" className="font-Inter text-[14px] font-medium text-[#fff]">spgeenveda@gmail.com</a>
        ...
        <div className="mt-[23px] flex">
          ...
          <div className="ml-[18px]">
            <a className="font-Inter text-[14px] font-medium text-[#fff]">Sodeput,Panihati,Kolkata,West Bengal</a>
      ...
      <div className="mt-6 flex w-full flex-col justify-between text-white sm:flex-row md:mt-0 md:max-w-[341px]">
        ...
        {/* <div className="mt-6 flex flex-col gap-4 sm:mt-0">
          ...
          <div className="flex gap-4 sm:flex-col">
            <a target="_blank" href="#"><img alt="facebook icon" loading="lazy" width={168} height={50} decoding="async" data-nimg={1} style={{color: 'transparent'}} src="https://www.svgrepo.com/show/303139/google-play-badge-logo.svg" /></a>
            <a target="_blank" href="#"><img alt="facebook icon" loading="lazy" width={168} height={50} decoding="async" data-nimg={1} style={{color: 'transparent'}} src="https://www.svgrepo.com/show/303128/download-on-the-app-store-apple-logo.svg" /></a>
          </div>
        </div> */}
      </div>
    </div>
    ...
    <div className="flex items-center justify-center pb-8 pt-[9px] md:py-8">
      <p className="text-[10px] font-normal text-white md:text-[12px]">
        © Copyright
        {/* */}2024
        {/* */}, All Rights Reserved by Ramkrishna Enterprise. |
        Crafted with ❤️ by Veda's
      </p>
    </div>
  </div>
</div>
